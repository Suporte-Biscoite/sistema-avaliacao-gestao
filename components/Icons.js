...
export const IconShield = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3L4 7v5c0 5 3.5 9.3 8 10.5C16.5 21.3 20 17 20 12V7L12 3z" />
...
export const IconStar = ({ size = 16, color = 'currentColor', filled = false }) => (
...
export const IconInbox = ({ size = 32, color = 'currentColor' }) => (
...
export const IconTrend = ({ size = 16, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
